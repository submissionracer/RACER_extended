...
- `experiments/run_context_noise.py`
  - Dedicated context-noise runner.
  - Uses the shared experiment helpers from `experiments/run_experiments.py`.
  - Defaults exclude low-rank variants.
...
```bash
python experiments/run_context_noise.py \
  ...
  --variants dense gated_offline support_offline \
