"""Run the one-dimensional baseline setting without low-rank variants.

The setting matches the baseline row:

    arms = 5, states = 8, batch size = 5, rounds = 1000, seeds = 10,
    contextual noise = 0.

This focused entry point keeps the baseline-setting sweep separate from the
generic multi-experiment runner while reusing the shared RMAB implementation.
"""
